...
@section('title', 'Data Margin Penjualan - Sistem Inventory')

@section('content')
@php
    $pageTitle = 'Data Margin Penjualan';
    $pageIcon = 'fa-percent';
@endphp
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h2><i class="fas fa-percent me-2"></i>Data Margin Penjualan</h2>
            <p>Kelola margin keuntungan penjualan</p>
        </div>
        <a href="{{ route('superadmin.margin.create') }}" class="btn btn-add">
...
<div class="filter-section">
    <h6><i class="fas fa-filter me-2"></i>Filter Status Margin</h6>
        ...
        <div class="table-responsive">
            <table class="table table-modern">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge-margin">
                                ...
                                {{ $margin->persen_display ?? number_format($margin->persen * 100, 2) . '%' }}
                            </span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            {{ $margin->tanggal_dibuat ?? date('d-m-Y H:i', strtotime($margin->created_at)) }}
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ $filter == 'all' ? 6 : 5 }}">
                            <div class="empty-state">
                                <i class="fas fa-percent"></i>
                                <h4>Belum Ada Data Margin 
                                    @if($filter == 'aktif')
                                        Aktif
                                    @endif
                                </h4>
                                <p>
                                    @if($filter == 'aktif')
                                        Belum ada margin dengan status aktif. 
                                        <a href="{{ route('superadmin.margin.index') }}">Lihat semua margin</a>
                                    @else
                                        Klik tombol "Tambah Margin" untuk menambahkan margin baru
                                    @endif
                                </p>
                            </div>
                        </td>
