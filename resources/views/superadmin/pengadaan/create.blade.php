...
@section('title', 'Tambah Pengadaan - Sistem Inventory')
...
<div class="page-header">
    <div>
        <h2><i class="fas fa-plus-circle me-2"></i>Tambah Pengadaan Baru</h2>
        <p>Buat transaksi pengadaan barang dari vendor</p>
    </div>
</div>
...
<div class="form-card">
    <div class="card-header">
        <h5><i class="fas fa-file-invoice me-2"></i>Form Pengadaan</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('superadmin.pengadaan.store') }}" method="POST" id="formPengadaan">
            ...
            <div class="info-box">
                ...
                <p><strong>Informasi:</strong> ID Pengadaan akan digenerate otomatis setelah data disimpan. Status awal adalah <strong>Pending</strong>.</p>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="vendor_idvendor" class="form-select @error('vendor_idvendor') is-invalid @enderror" required>
                        ...
                        @foreach($vendors as $v)
                            <option value="{{ $v->idvendor }}" {{ old('vendor_idvendor') == $v->idvendor ? 'selected' : '' }}>
                        ...
                        <tr id="emptyRow">
                            <td colspan="8">
                                <div class="empty-state-table">
                                    ...
                                    <p>Belum ada barang dipilih. Tambahkan barang dari form di atas.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        ...
                        <tr>
                            <th colspan="6" class="text-end">
                                PPN (<span id="displayPPNPercent">10</span>%):
                            </th>
                            <th class="text-end">
