...
@section('title', 'Data Satuan - Sistem Inventory')

@section('content')
@php
    $pageTitle = 'Data Satuan';
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h2><i class="fas fa-balance-scale me-2"></i>Data Satuan</h2>
            <p>Kelola data satuan barang</p>
        </div>
        <a href="{{ route('superadmin.satuan.create') }}" class="btn btn-add">
...
<div class="filter-section">
    <h6><i class="fas fa-filter me-2"></i>Filter Status Satuan</h6>
        ...
        <div class="table-responsive">
            <table class="table table-modern">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong>#{{ $satuan->idsatuan }}</strong></td>
                        <td>
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ $filter == 'all' ? 4 : 3 }}">
                            <div class="empty-state">
                                <i class="fas fa-balance-scale"></i>
                                <h4>Belum Ada Data Satuan 
                                    @if($filter == 'aktif')
                                        Aktif
                                    @endif
                                </h4>
                                <p>
                                    @if($filter == 'aktif')
                                        Belum ada satuan dengan status aktif. 
                                        <a href="{{ route('superadmin.satuan.index') }}">Lihat semua satuan</a>
                                    @else
